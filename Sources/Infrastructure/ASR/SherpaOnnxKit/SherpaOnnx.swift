// ─────────────────────────────────────────────────────────────────────
// Vendored from https://github.com/k2-fsa/sherpa-onnx
//   File:    swift-api-examples/SherpaOnnx.swift
//   Tag:     v1.13.0  (re-fetch via ./scripts/fetch-sherpa-onnx.sh)
//   License: Apache-2.0  © 2023 Xiaomi Corporation
//
// LOCAL MODIFICATION:
//   Added the `import CSherpaOnnx` line below so this file resolves the
//   sherpa-onnx C API symbols via the Clang module declared in
//   vendor/sherpa-onnx.xcframework/...Headers/module.modulemap (synthesized
//   by fetch-sherpa-onnx.sh). The upstream copy expects an Xcode bridging
//   header, which SwiftPM does not support.
// ─────────────────────────────────────────────────────────────────────
import CSherpaOnnx
